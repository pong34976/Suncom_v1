...
type: "POST",
url:  `model/hardware.php?keyword=${key}`,
...
$('#id_hardware').val(Name.find('td:first').text());
$('#re_type').val(Name.find('td:nth-child(2)').text());
$('#re_model').val(Name.find('td:nth-child(3)').text());
$('#img').val(Name.find('td:nth-child(4)').text());
